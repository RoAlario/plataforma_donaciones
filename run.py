...
from app.models import Rol, Categoria, EstadoPublicacion, SolicitudDonacion, EstadoSolicitudDonacion, OfertaCampana
...
def crear_estados_iniciales():
    estados = ['Disponible', 'A evaluar', 'En progreso', 'Entregado', 'Cancelado', 'Finalizado']
